...
public class MainActivity extends AppCompatActivity implements ShoeItemAdapter.ShoeClickedListeners {
    ...
    private void setUpList() {
        ...
        shoeItemList.add(new ShoeItem("Black dress", "dress", R.drawable.fostan, 16.5,"red","l","in stock",3));
        shoeItemList.add(new ShoeItem("pants", "Casual", R.drawable.bantlon, 20,"red","l","in stock",3));
        shoeItemList.add(new ShoeItem("Tag Women's chain", "accessories", R.drawable.kinga, 22,"red","l","in stock",3));
        shoeItemList.add(new ShoeItem("His pharaohs Women's chain", "accessories", R.drawable.fra3na, 12,"red","l","in stock",3));
